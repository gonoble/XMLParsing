...
//  XMLParsing
//
//  Created by 402-13 on 2018. 8. 12..
//  Copyright © 2018년 402-13. All rights reserved.
//
...
class RootViewController: UITableViewController, XMLParserDelegate {
    ...
    override func viewDidLoad() {
        ...
        print("aaaasdkfjalksdfjlksdjfalksfjdlkfjaslkfjkldsjflakjdfklfjdsklfjalkfjdlksfjl;afjdslkfjsfjfjslkfa;fjda;fja;fjad;lkjaaㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁㅁ")
        //title은 네비게이션 바 중앙의 문자열이 되고 탭 바의 경우에는 탭 바 아이템의 문자열이 됩니다.
        self.title = "Book"
    ...
    */
    ...
    //elementName : 태그 이름, attributeDict : 속성과 값을 저장하고 있는 디셔너리
    func parser(_ parser: XMLParser, didStartElement elementName: String, namespaceURI: String?, qualifiedName qName: String?, attributes attributeDict: [String : String] = [:]){
        //Book 태그를 만나면 새로운 데이터를 저장할 수 있는 인스턴스를 생성하고 태그안에 있는 Id의 값을 저장
        if(elementName == "Book"){
            book = Book()
    ...
    //태그 안의 내용을 만날때 호출되는 메소드, string:태그안의 문자열
    //태그 안의 문자열은          한번에 전체를 다 못 가져올 수 있습니다.
    //처음일때는 문자열을 바로 저장하고 그렇지 않을 때는 이전 문자열과 합쳐야 합니다.
    ...
    //태그를 닫을 때 호출되는 메소드, elementName가 태그 이름
